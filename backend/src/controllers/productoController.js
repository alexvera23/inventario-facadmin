...
class ProductoController {
    ...
    // Controlador actualizado para Paginación y Filtros
    async obtenerProductos(req, res) {
        try {
            // Extraemos todo del query string de la URL
            const { page, limit, busqueda, edificio } = req.query;
            ...
            // Devolvemos el objeto completo con { data, pagination }
