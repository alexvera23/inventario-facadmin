...
router.post('/', verificarToken, checkRole(['ADMIN']), productoController.crearProducto);
...
router.post('/:id/embalajes', verificarToken, checkRole(['ADMIN']), productoController.agregarEmbalaje);
